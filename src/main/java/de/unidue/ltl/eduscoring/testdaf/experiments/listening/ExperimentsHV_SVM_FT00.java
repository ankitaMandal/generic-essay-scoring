...
import de.unidue.ltl.eduscoring.testdaf.io.TestDafListeningDataPhoneticRepresentationReader_FT00;
import de.unidue.ltl.eduscoring.testdaf.io.TestDafListeningDataReader_FT00;

public class ExperimentsHV_SVM_FT00 extends Experiments_ImplBase{
			...
			throws Exception
	{
		...
		//runTestDaf(true, TestDafListeningDataReader_FT00.itemIds);
		//runTestDafPhonetic(true, TestDafListeningDataReader_FT00.itemIds);
		runTestDafLearningCurve(TestDafListeningDataReader_FT00.itemIds);
	}
	...
	private static void runTestDaf(boolean useCV, String ... questionIds) 
			throws Exception
	{
		String data           = ResourcesFilePath+"/datasets/TestDaF/HV/FT00/Bewertungen_UTF8_final.tsv";
		String[] goldLabels = {"FINAL", "TEACHER1", "TEACHER2", "ADJUDICATED"};
		for (String goldLabel : goldLabels){
			for (String id : questionIds) {
				System.out.println(id);
				CollectionReaderDescription readerTrain = CollectionReaderFactory.createReaderDescription(
						TestDafListeningDataReader_FT00.class,
						TestDafListeningDataReader_FT00.PARAM_INPUT_FILE, data,
						TestDafListeningDataReader_FT00.PARAM_QUESTION_ID, id,
						TestDafListeningDataReader_FT00.PARAM_GRADE_TYPE, goldLabel);
			...
			throws Exception
	{
		...
		for (String goldLabel : goldLabels){
			for (String id : questionIds) {
				CollectionReaderDescription readerTrain = CollectionReaderFactory.createReaderDescription(
						TestDafListeningDataPhoneticRepresentationReader_FT00.class,
						TestDafListeningDataPhoneticRepresentationReader_FT00.PARAM_INPUT_FILE, data,
						TestDafListeningDataPhoneticRepresentationReader_FT00.PARAM_QUESTION_ID, id,
						TestDafListeningDataReader_FT00.PARAM_GRADE_TYPE, goldLabel);
