...
import de.unidue.ltl.eduscoring.testdaf.io.TestDafListeningDataReader_FT01.GradeType;

public class ExperimentsHV_SVM_FT01 extends Experiments_ImplBase{
			...
			throws Exception
	{
		...
		//runTestDaf(true, TestDafListeningDataReader_FT01.itemIds);
		//runTestDafPhonetic(true, TestDafListeningDataReader_FT01.itemIds);
		runTestDafLearningCurve(TestDafListeningDataReader_FT01.itemIds);
	}

	private static void runTestDaf(boolean useCV, String ... questionIds) 
			throws Exception
	{
		String data           = ResourcesFilePath+"/datasets/TestDaF/HV/FT01/FT01_annotiert_final.tsv";
		String[] goldLabels = {"SZ", "GK", "LS", "Kru", "DM", "gesamt"};
		for (String goldLabel : goldLabels){
			for (String id : questionIds) {
				System.out.println(id);
				CollectionReaderDescription readerTrain = CollectionReaderFactory.createReaderDescription(
						TestDafListeningDataReader_FT01.class,
						TestDafListeningDataReader_FT01.PARAM_INPUT_FILE, data,
						TestDafListeningDataReader_FT01.PARAM_QUESTION_ID, id,
						TestDafListeningDataReader_FT01.PARAM_GRADE_TYPE, goldLabel);
			...
			throws Exception
	{
		...
		for (String goldLabel : goldLabels){
			for (String id : questionIds) {
				CollectionReaderDescription readerTrain = CollectionReaderFactory.createReaderDescription(
						TestDafListeningDataPhoneticRepresentationReader_FT01.class,
						TestDafListeningDataPhoneticRepresentationReader_FT01.PARAM_INPUT_FILE, data,
						TestDafListeningDataPhoneticRepresentationReader_FT01.PARAM_QUESTION_ID, id,
						TestDafListeningDataReader_FT01.PARAM_GRADE_TYPE, goldLabel);
