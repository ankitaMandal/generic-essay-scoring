...
import de.unidue.ltl.eduscoring.testdaf.io.TestDafListeningDataReader_FT03;
import de.unidue.ltl.eduscoring.testdaf.io.TestDafListeningDataReader_FT03.GradeType;

public class ExperimentsHV_SVM_FT03 extends Experiments_ImplBase{
			...
			throws Exception
	{
		...
		runTestDafLearningCurve(TestDafListeningDataReader_FT03.itemIds);
	}

	private static void runTestDaf(boolean useCV, String ... questionIds) 
			throws Exception
	{
		String data           = ResourcesFilePath+"/datasets/TestDaF/HV/FT03/Automatic Scoring/Set1.tsv";
		...
		for (String goldLabel : goldLabels){
			for (String id : questionIds) {
				...
				CollectionReaderDescription readerTrain = CollectionReaderFactory.createReaderDescription(
						TestDafListeningDataReader_FT03.class,
						TestDafListeningDataReader_FT03.PARAM_INPUT_FILE, data,
						TestDafListeningDataReader_FT03.PARAM_QUESTION_ID, id,
						TestDafListeningDataReader_FT03.PARAM_GRADE_TYPE, goldLabel);
